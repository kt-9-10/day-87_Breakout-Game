...
is_bouncing_wall = False
is_bouncing_block = False

block_pos_list = [
    (-360, 200), (-280, 200), (-200, 200), (-120, 200), (-40, 200), (40, 200), (120, 200), (200, 200), (280, 200),
    (360, 200),
    (-360, 160), (-280, 160), (-200, 160), (-120, 160), (-40, 160), (40, 160), (120, 160), (200, 160), (280, 160),
    (360, 160),
    (-360, 120), (-280, 120), (-200, 120), (-120, 120), (-40, 120), (40, 120), (120, 120), (200, 120), (280, 120),
    (360, 120),
...
while True:
    ...
    if paddle_col_left < ball_x < paddle_col_right and paddle_col_bottom < ball_y < paddle_col_top:
        if not is_bouncing_wall:
            ball.bounce_by_paddle(paddle.towards(ball))
            is_bouncing_wall = True
    else:
        is_bouncing_wall = False
    ...
    if not block_list:
        clear_txt = Turtle()
        clear_txt.penup()
        clear_txt.color("gold")
        clear_txt.hideturtle()
        clear_txt.clear()
        clear_txt.goto(0, 0)
        clear_txt.write("C L E A R", align="center", font=("Courier", 60, "bold"))
        screen.update()
        break
